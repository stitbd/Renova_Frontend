        ...
        <div>
            <div className="page-header">
                ...
                <div className="page-actions">
                    <button onClick={() => router.push("/supar-admin-panel/staff")} className="btn-secondary-outline"><Icon n="back" s={14} c="#475569" /> Back</button>
                    <button onClick={() => router.push("/supar-admin-panel/staff")} className="btn-primary-green"><Icon n="check" s={14} c="#fff" /> Update Staff</button>
                </div>
            </div>

            <div className="alert-banner info">
                <Icon n="badge" s={16} c="#014fa1" />
                    ...
                    <Grid2>
                        <Field label="Mobile Number" required>
                            <div className="phone-input-group">
                                <div className="country-code"><span className="flag">🇧🇩</span><Icon n="chevDown" s={13} c="#94a3b8" /><span>+880</span></div>
                    ...
                    <Grid2>
                        ...
                        <Field label="New Password" hint="Leave blank to keep existing password">
                            <div className="password-wrapper">
                                ...
                                <button onClick={() => setShowPass(!showPass)} className="password-toggle"><Icon n={showPass ? "eyeOff" : "eye"} s={16} c="#94a3b8" /></button>
                            </div>
                        </Field>
                    </Grid2>
                </div>
            ...
            <div className="form-footer right">
                <div className="footer-buttons">
                    ...
                    <button onClick={() => router.push("/supar-admin-panel/staff")} className="btn-primary"><Icon n="check" s={15} c="#fff" /> Update Staff</button>
                </div>
            </div>
        </div>
    );
