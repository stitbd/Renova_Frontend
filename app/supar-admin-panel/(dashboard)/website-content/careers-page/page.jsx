...
const CareersPage = () => {
  ...
  const sections = [
    ...
    { id: "careers-content", label: "Careers Content", icon: FileText },
    { id: "careers-questions", label: "Questions & Answers", icon: HelpCircle },
    { id: "careers-support", label: "Support & Contact", icon: MessageCircle },
    { id: "careers-features", label: "Features Section", icon: Star },
