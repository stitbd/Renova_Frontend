...
const PAGE_TREE = [
  ...
  { id: "doctors", label: "Doctors", href: "/doctors-page", icon: "doctors" },
  {
    ...
    icon: "services",
    children: [
      { id: "services-pathology", label: "Pathology & Lab Testing", href: "/services-page" },
      { id: "services-blood", label: "Blood Test & Biochemistry", href: "/services-page" },
      { id: "services-hematology", label: "Hematology Services", href: "/services-page" },
      { id: "services-hormone", label: "Hormone & Immunology Tests", href: "/services-page" },
      { id: "services-urine", label: "Urine & Stool Analysis", href: "/services-page" },
      { id: "services-xray", label: "Digital X-Ray", href: "/services-page" },
      { id: "services-usg", label: "Ultrasonography (USG)", href: "/services-page" },
      { id: "services-doppler", label: "Color Doppler Imaging", href: "/services-page" },
      { id: "services-ecg", label: "ECG (Electrocardiogram)", href: "/services-page" },
      { id: "services-echo", label: "Echocardiography (ECHO)", href: "/services-page" },
      { id: "services-ct", label: "CT Scan Services", href: "/services-page" },
      { id: "services-mri", label: "MRI Scan Services", href: "/services-page" },
      { id: "services-mammography", label: "Mammography", href: "/services-page" },
      { id: "services-endoscopy", label: "Endoscopy & Colonoscopy", href: "/services-page" },
      { id: "services-pft", label: "Pulmonary Function Test", href: "/services-page" },
      { id: "services-eeg", label: "EEG & EMG Testing", href: "/services-page" },
      { id: "services-cardiology", label: "Cardiology Diagnostics", href: "/services-page" },
      { id: "services-diabetes", label: "Diabetes Screening", href: "/services-page" },
      { id: "services-kidney", label: "Kidney Function Tests", href: "/services-page" },
      { id: "services-liver", label: "Liver Function Tests", href: "/services-page" },
      { id: "services-thyroid", label: "Thyroid Profile Tests", href: "/services-page" },
      { id: "services-cancer", label: "Cancer Screening", href: "/services-page" },
      { id: "services-packages", label: "Health Checkup Packages", href: "/services-page" },
      { id: "services-fullbody", label: "Full Body Health Checkup", href: "/services-page" },
      { id: "services-covid", label: "Covid-19 & Viral Screening", href: "/services-page" },
      { id: "services-home-sample", label: "Home Sample Collection", href: "/services-page" },
      { id: "services-consultation", label: "Doctor Consultation", href: "/services-page" },
      { id: "services-specialist", label: "Specialist Chamber", href: "/services-page" },
      { id: "services-womens", label: "Women's Health Diagnostics", href: "/services-page" },
      { id: "services-child", label: "Child Health Diagnostics", href: "/services-page" },
      { id: "services-prenatal", label: "Prenatal & Pregnancy", href: "/services-page" },
      { id: "services-corporate", label: "Corporate Health Screening", href: "/services-page" },
      { id: "services-emergency", label: "Emergency Diagnostic", href: "/services-page" },
      { id: "services-digital", label: "Digital Reporting", href: "/services-page" },
    ],
  },
