...
import { UserCheck, Layout, Search, UserPlus, User, Users, List, Clock, Star, Heart, Calendar, 
  MessageCircle, Award, Check, ChevronDown, Save, RefreshCw, Eye, Upload, Trash, Plus, X, MapPin, 
  Phone, Mail, ArrowLeft, Share2, BookOpen, Globe, PhoneCall, Clock as ClockIcon, Calendar as CalendarIcon, 
  Home, ChevronRight, Menu, X as XIcon, Edit, Tag, Stethoscope, Briefcase, GraduationCap, Building2, 
  ShieldCheck, BadgeCheck, AlertCircle, Copy, ArrowUp, ArrowDown, Minus, Maximize2, Minimize2, Settings, Filter } from "lucide-react";
import "./doctors.css";
