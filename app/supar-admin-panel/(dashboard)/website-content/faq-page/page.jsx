...
const FaqPage = () => {
  ...
  const sections = [
    { id: "faq-hero", label: "Hero Section", icon: Layout },
    { id: "faq-categories", label: "FAQ Categories", icon: FileText },
    { id: "faq-questions", label: "Questions & Answers", icon: HelpCircle },
    { id: "faq-support", label: "Support & Contact", icon: MessageCircle },
    { id: "faq-features", label: "Features Section", icon: Star },
