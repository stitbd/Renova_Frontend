...
import "./super-admin-panel-patients.css";
    ...
    <motion.div variants={container} initial="hidden" animate="show">
      ...
      <motion.div className="data-table-container" variants={item}>
        <div className="table-header">
          ...
          <button onClick={() => router.push("/supar-admin-panel/patients/new-patient")} className="btn-primary-green">
                ...
                <motion.tr key={patient.id} variants={item} whileHover={{ backgroundColor: "#f8fafc" }}>
                  ...
                  <td>
                    <div className="action-buttons">
                      <button
                        onClick={() => router.push(`/supar-admin-panel/patients/patient-profile?id=${patient.id}`)}
                        className="action-btn"
                      >
                        <Eye size={14} color="#64748b" />
                      </button>
                      <button
                        onClick={() => router.push(`/supar-admin-panel/patients/patient-profile?id=${patient.id}&edit=true`)}
                        className="action-btn"
                      >
          ...
          {filteredPatients.map((patient) => (
            <div key={patient.id} className="staff-card">
              ...
              <div className="staff-card-actions">
                <button onClick={() => router.push(`/supar-admin-panel/patients/patient-profile?id=${patient.id}`)} className="action-btn">
                  <Eye size={14} color="#64748b" />
                  <span>View</span>
                </button>
                <button onClick={() => router.push(`/supar-admin-panel/patients/patient-profile?id=${patient.id}&edit=true`)} className="action-btn">
                  <Edit size={14} color="#64748b" />
                  <span>Edit</span>
                </button>
                <button
