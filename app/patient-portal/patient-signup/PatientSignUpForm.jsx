...
// ── main component ────────────────────────────────────────────
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "https://d55e-2401-f40-1587-0-ed4f-4bed-3dd2-b569.ngrok-free.app/api/v1";
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="ps-grid">
              ...
              <Field label="Mobile Number (OTP)" required>
                <div className="ps-otp-row">
                  <Input icon={Icon.Phone} type="tel" placeholder="+880 1XXX-XXXXXX" value={formData.mobileNumber} onChange={set("mobileNumber")} required />
            ...
            <div className="ps-grid">
              ...
              <Field label="Password" required>
                <Input icon={Icon.ID} type="password" placeholder="Enter password" value={formData.password} onChange={set("password")} required />
              </Field>
            </div>
            ...
            <div className="ps-grid">
              <Field label="Gender" required>
                <Select icon={Icon.User} value={formData.gender} onChange={set("gender")} required>
            ...
            <div className="ps-grid">
              <Field label="Nationality" required>
                <Select icon={Icon.Globe} value={formData.nationality} onChange={set("nationality")} required>
              ...
              <Field label="Emergency Contact">
                <Input icon={Icon.Phone} type="tel" placeholder="Enter emergency contact" value={formData.emergencyContact} onChange={set("emergencyContact")} />
              </Field>
            </div>
