    ...
    <div className="">
      ...
      <div className="profile-header-card">
        <div className="profile-main-info">
          ...
          <a href="/patient-portal/profile" className="edit-profile-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="stats-grid">
        <div className="stat-card reports">
          ...
          <div className="stat-content">
            ...
            <a href="/patient-portal/reports" className="stat-link">View all reports →</a>
          </div>
        </div>
        <div className="stat-card prescriptions">
          ...
          <div className="stat-content">
            ...
            <a href="/patient-portal/prescriptions" className="stat-link">View all prescriptions →</a>
          </div>
        </div>
        <div className="stat-card consultations">
          ...
          <div className="stat-content">
            ...
            <a href="/patient-portal/consultations" className="stat-link">View history →</a>
          </div>
        </div>
        <div className="stat-card appointments">
          ...
          <div className="stat-content">
            ...
            <a href="/patient-portal/appointments" className="stat-link">View appointments →</a>
          </div>
        </div>
        <div className="stat-card health-score">
          ...
          <div className="stat-content">
            ...
            <a href="/patient-portal/health-summary" className="stat-link">View details →</a>
          </div>
        </div>
      </div>
        ...
        <div className="dashboard-right-column">
          ...
          <div className="upcoming-appointment-card">
            <div className="appointment-header">
              ...
              <a href="/patient-portal/appointments" className="view-all-link">View All →</a>
            </div>
          ...
          <div className="quick-actions-card">
            ...
            <div className="quick-actions-grid">
              <a href="/patient-portal/appointments" className="quick-action-btn">
